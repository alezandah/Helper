...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { campaign_id: @contribution.campaign_id, comment: @contribution.comment, donation_amount: @contribution.donation_amount, email: @contribution.email, first_name: @contribution.first_name, last_name: @contribution.last_name }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { campaign_id: @contribution.campaign_id, comment: @contribution.comment, donation_amount: @contribution.donation_amount, email: @contribution.email, first_name: @contribution.first_name, last_name: @contribution.last_name }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
